        ...
        <div class="contenido" id="lista"  >
            ...
            <%
                if (request.getParameter("nombre") != null) {
                    ...
                    Registro.setNoIdent(NoIdent);
                    Registro.setTipoIdent(TipoIdent);
                    Registro.setGenero(Genero);
                    Registro.setCorreo(Correo);
                    
                    if (Registro.guardarUsuario()) {
                        // pregunta si se guarad el registor en la base de datos
                        // se muestra el registro en una tabla
                    %>
                    <table>
                        <tr>
                            <td><%=Nombre%></td>
                    ...
                    // no se ha guardado el registro, se muestra mensaje de error
                    else {
                    %>
